...
@Builder
@ToString
public class DeclarationAnnuelleDetailDTO implements Serializable {
    ...
    private Long declarationAnnuelId;
    ...
    public Long getDeclarationAnnuelId() {
        return declarationAnnuelId;
    }

    public void setDeclarationAnnuelId(Long declarationAnnuelId) {
        this.declarationAnnuelId = declarationAnnuelId;
    }
}
