...
@Repository
public interface QuittanceMensuelleLigneRepository extends JpaSpecificationExecutor<QuittanceMensuelleLigne>, JpaRepository<QuittanceMensuelleLigne, Long> {
