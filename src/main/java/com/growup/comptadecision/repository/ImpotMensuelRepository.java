...
@Repository
public interface ImpotMensuelRepository extends JpaSpecificationExecutor<ImpotMensuel>, JpaRepository<ImpotMensuel, Long> {
    ...
    @Query("select impotMensuel from ImpotMensuel impotMensuel " +
            "left join fetch impotMensuel.impotMensuelLignes impotMensuelLigne " +
