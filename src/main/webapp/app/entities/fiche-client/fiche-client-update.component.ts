...
export class FicheClientUpdateComponent implements OnInit {
    ...
    formatDecimalFields() {
        ...
        if (this.ficheClient.tauxCnssAccident) {
            this.ficheClient.tauxCnssAccident = ComptaDecisionUtils.formatTaux(this.ficheClient.tauxCnssAccident);
        }
        if (this.ficheClient.tauxCnssKarama) {
            this.ficheClient.tauxCnssKarama = ComptaDecisionUtils.formatTaux(this.ficheClient.tauxCnssKarama);
        }
        if (this.ficheClient.tauxCnssNormal) {
            this.ficheClient.tauxCnssNormal = ComptaDecisionUtils.formatTaux(this.ficheClient.tauxCnssNormal);
        }
