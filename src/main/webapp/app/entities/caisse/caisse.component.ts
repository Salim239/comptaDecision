...
export class CaisseComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.caisseService
            ...
            .subscribe(
                (res: HttpResponse<ICaisse[]>) => this.paginateCaisses(res.body, res.headers),
    ...
    trackId(index: number, item: ICaisse) {
        return item.id;
    }
    ...
    protected paginateCaisses(data: ICaisse[], headers: HttpHeaders) {
