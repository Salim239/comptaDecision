...
export class ApplicationUserComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.applicationUserService
            ...
            .subscribe(
                (res: HttpResponse<IApplicationUser[]>) => this.paginateApplicationUsers(res.body, res.headers),
    ...
    protected paginateApplicationUsers(data: IApplicationUser[], headers: HttpHeaders) {
