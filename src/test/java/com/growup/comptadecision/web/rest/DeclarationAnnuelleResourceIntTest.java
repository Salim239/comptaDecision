...
public class DeclarationAnnuelleResourceIntTest {
    ...
    public static DeclarationAnnuelle createEntity(EntityManager em) {
        DeclarationAnnuelle declarationAnnuelle = new DeclarationAnnuelle()
            ...
            .montantChiffreAffaireHT(DEFAULT_MONTANT_CHIFFRE_AFFAIRE_HT)
            .montantChiffreAffaireExport(DEFAULT_MONTANT_CHIFFRE_AFFAIRE_EXPORT)
            .montantChiffreAffaireImpot(DEFAULT_MONTANT_CHIFFRE_AFFAIRE_IMPOT)
            .montantChiffreAffaireTTC(DEFAULT_MONTANT_CHIFFRE_AFFAIRE_TTC)
            .montantResultatComptable(DEFAULT_MONTANT_RESULTAT_COMPTABLE)
            .montantDeductionCommune(DEFAULT_MONTANT_DEDUCTION_COMMUNE)
            .montantAutreDeduction(DEFAULT_MONTANT_AUTRE_DEDUCTION)
            .montantBaseImposable(DEFAULT_MONTANT_BASE_IMPOSABLE)
            .montantImpotLiquide(DEFAULT_MONTANT_IMPOT_LIQUIDE)
            .montantAcompteProvisionnel(DEFAULT_MONTANT_ACOMPTE_PROVISIONNEL)
            .montantRetenueSource(DEFAULT_MONTANT_RETENUE_SOURCE)
            .montantNetAPaye(DEFAULT_MONTANT_NET_A_PAYE);
