...
describe('Service Tests', () => {
    describe('Activite Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Activite(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a Activite', async () => {
            ...
            it('should update a Activite', async () => {
                const returnedFromService = Object.assign(
                    {
                        code: 'BBBBBB',
                        libelle: 'BBBBBB',
            ...
            it('should return a list of Activite', async () => {
                const returnedFromService = Object.assign(
                    {
                        code: 'BBBBBB',
                        libelle: 'BBBBBB',
            ...
            it('should delete a Activite', async () => {
