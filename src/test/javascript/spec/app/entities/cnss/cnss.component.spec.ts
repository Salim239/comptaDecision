...
import { CnssComponent } from 'app/entities/cnss/cnss.component';
import { CnssService } from 'app/entities/cnss/cnss.service';
import { Cnss } from 'app/shared/model/cnss.model';

describe('Component Tests', () => {
    describe('Cnss Management Component', () => {
        let comp: CnssComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(CnssComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.cnsses[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
