...
describe('Service Tests', () => {
    describe('SecteurActivite Service', () => {
        ...
        describe('Service methods', async () => {
            ...
            it('should create a SecteurActivite', async () => {
                ...
                service
                    .create(new SecteurActivite(null))
                    .pipe(take(1))
            ...
            it('should update a SecteurActivite', async () => {
                const returnedFromService = Object.assign(
                    {
                        code: 'BBBBBB',
                        libelle: 'BBBBBB',
            ...
            it('should return a list of SecteurActivite', async () => {
                const returnedFromService = Object.assign(
                    {
                        code: 'BBBBBB',
                        libelle: 'BBBBBB',
            ...
            it('should delete a SecteurActivite', async () => {
