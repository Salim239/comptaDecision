...
import { FicheClientComponent } from 'app/entities/fiche-client/fiche-client.component';
...
describe('Component Tests', () => {
    describe('FicheClient Management Component', () => {
        let comp: FicheClientComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(FicheClientComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.ficheClients[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
