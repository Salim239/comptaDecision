...
import { DeclarationAnnuelleComponent } from 'app/entities/declaration-annuelle/declaration-annuelle.component';
...
describe('Component Tests', () => {
    describe('DeclarationAnnuelle Management Component', () => {
        let comp: DeclarationAnnuelleComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(DeclarationAnnuelleComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            spyOn(service, 'query').and.returnValue(
                of(
                    new HttpResponse({
                        body: [new DeclarationAnnuelle(123)],
                        headers
                    })
                )
            );
            ...
            expect(comp.declarationAnnuelles[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
